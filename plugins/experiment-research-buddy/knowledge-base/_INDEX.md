...
Last updated: 2026-08-24 (added s-rct-agent-simulation-2026.md — Amazon Science/COLM 2026 paper on AI-agent A/B test simulation: sign overlap 0.70 but overshoots magnitudes, requires calibration; added sequential-sample-size-correction-spotify-2026.md — Spotify closed-form k* correction saves 8–20% sample budget for sequential tests, validated on 713 production metrics; updated spotify.md with Recent section)
