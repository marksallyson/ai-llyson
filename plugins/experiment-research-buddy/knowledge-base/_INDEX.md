...
Last updated: 2026-09-21 (1 new paper: persona-conditioned-agents-ab-simulation-emnlp2026.md — Amazon/EMNLP 2026 paper on using behavioral-data-grounded AI agents to pre-screen A/B tests, 0.75–0.90 directional accuracy on 40 tests; updated airbnb.md with Recent section for "Beyond the model: Engineering AI infra with scientific judgement" — September 2026 post on encoding scientific methodology into AI agent infrastructure for data exploration)
...
| [llm-ab-testing-surrogacy-2026.md](papers/llm-ab-testing-surrogacy-2026.md) | Statistical Foundations of LLM-based A/B Testing: A Surrogacy Framework for Human Causal Inference (arXiv 2606.17165, June 2026) | LLM outputs recover only 39% of human treatment effects raw; calibration closes the gap; "A/B testing on LLMs is correct only by assumption, not by design" — formalizes when LLM-based evaluation is valid |
| [mid-estimator-algorithm-comparison-kdd2026.md](papers/mid-estimator-algorithm-comparison-kdd2026.md) | A More Accurate Algorithm Comparison through A/B Testing using Offline Evaluation Methods — MID Estimator (Konishi et al., KDD 2026) | Introduces a "middle algorithm" that induces positive correlation between two A/B arms, cutting sample requirements ~50% for algorithm comparison experiments; bridges offline evaluation and live A/B testing |
| [policy-overlap-variance-reduction-jeunen-2026.md](papers/policy-overlap-variance-reduction-jeunen-2026.md) | Accelerating A/B-Tests with Counterfactual Estimation: Reducing Variance through Policy Overlap (Jeunen, arXiv July 2026) | When treatment and control policies agree on an action the outcome is pure noise — Δ-OPE exploits this structural overlap to reduce variance without changing the randomization assumption; especially relevant for ranking and recommender system experiments |
| [training-logs-model-comparison-icml2026.md](papers/training-logs-model-comparison-icml2026.md) | Can Training Logs Make Model Comparisons More Precise? (Huang, ICML Workshop 2026) | Early training log statistics serve as arm-specific CUPED covariates to reduce variance when comparing stochastically trained ML models; targeted covariate selection required — broad search backfires |
| [evaluating-long-term-industry-workshop-2026.md](papers/evaluating-long-term-industry-workshop-2026.md) | Evaluating for the Long Term: Learnings from Industry (26 co-authors from 15 platforms, arXiv 2608.08043, August 2026) | Cross-industry workshop consensus: sign reversals from short- to long-run effects are rare; autosurrogate (same metric, earlier) often hard to beat; experimentally-learned surrogates preferred; novelty effects concentrate in pricing and content quality |
| [bayesian-ab-testing-overview-spotify-2026.md](papers/bayesian-ab-testing-overview-spotify-2026.md) | Bayesian Inference Procedures for A/B Testing: An Overview (Schultzberg & Frånberg, Spotify, arXiv 2608.12949, August 2026) | Maps Bayesian A/B testing into 3-tier hierarchy (no error control → Bayes factor stopping → empirical Bayes); many commercial platforms default to Tier 1 with no peeking protection; Bayes factor stopping near-optimal for most cost functions |
| [sequential-sample-size-correction-spotify-2026.md](papers/sequential-sample-size-correction-spotify-2026.md) | A Closed-Form Sample Size Correction for Always-Valid Inference with Optional Stopping (Schultzberg, Spotify, arXiv 2606.18366, June 2026) | Closed-form k* factor replaces conservative "last-point" heuristic for sequential test sizing; saves 8–20% sample budget; validated on 713 production metrics at Spotify with median 9.5% saving |
| [s-rct-agent-simulation-2026.md](papers/s-rct-agent-simulation-2026.md) | Can AI Agents Simulate A/B Test Outcomes? A Validation Framework for Agentic Experimentation (Hut & Masoero, Amazon Science, arXiv 2608.02345, COLM 2026) | S-RCT framework formalizes AI-agent simulation of A/B tests; off-the-shelf LLM achieves sign overlap 0.70 on 67 historical marketing tests but overshoots effect magnitudes; calibration required before simulation can gate launch decisions |
| [network-interference-specification-testing-2026.md](papers/network-interference-specification-testing-2026.md) | Randomization Tests for Model Specification in Causal Inference under Network Interference (Tiwari & Basu, arXiv 2608.22890, August 2026) | First practical randomization test to check whether an exposure mapping model is correctly specified under network interference; asymptotically valid; fills the key diagnostic gap in interference-aware experimental analysis |
| [trustworthy-ab-patterns-winners-curse-kdd2026.md](papers/trustworthy-ab-patterns-winners-curse-kdd2026.md) | Trustworthy A/B Patterns and the Winner's Curse: Lessons from Eight Large-Scale Replications (Kohavi, Vermeer et al., KDD 2026) | 8 high-powered replications of popular UX patterns; only 2/8 significant in expected direction; exaggeration factors at 20/50/80% power are 130%/40%/13%; empirically grounds the winner's curse for practitioners |
