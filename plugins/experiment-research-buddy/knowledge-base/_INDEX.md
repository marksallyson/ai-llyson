...
Last updated: 2026-08-31 (added network-interference-specification-testing-2026.md — first randomization test for exposure mapping model specification under network interference, August 24 arXiv submission; updated spotify.md with Recent section for Spotify Engineering Blog post on when LLM outcomes can validly replace human outcomes in A/B tests)
