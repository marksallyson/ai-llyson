...
- **MBTI**: ESTJ
- **Enneagram**: Type 1
- **What this means for coaching**: Type 1s hate being incompetent at things. ESTJs want to be in command of their work. Being new at something and visibly bad at it is a personal nightmare combo — reframe struggles as temporary beginner phases, not character flaws. When she says "I hate this work," check whether it's really "I hate being bad at this yet."

---

## Career Direction

- **Target trajectory**: Running models, running experiments, using inputs to predict what could happen — the full Decision Scientist skill set
- **Open question**: Also exploring whether DS leadership (management) could be a fit
- **Career signal**: Dislikes analytics engineering, loves insight/discovery work — points toward the Decision Science / product analytics fork, not the engineering fork
...
### Known milestones to track
- [ ] Deliver a first major project/analysis with measurable business impact
...
### Energy & Focus
- **Peak brain hours**: 4–6pm is sharpest, but actively trying to become a morning person (goal: in by 8:30, out by 4). There's a tension here between natural energy and desired schedule — worth monitoring.
- **Good day looks like**: Answered something for a stakeholder, made real progress on a project, had an insight worth sharing
- **In flow when**: No blockers, knows where to look, thinking of good questions, not sure what the data will show but knows how to find out

### Collaboration style
- **Currently**: Prefers working alone and going deep
- **History**: Used to get energy from collaboration — worked in marketing, more collaborative roles. Last company was toxic and burned her out. The shift toward solo work may be partly burnout recovery, not purely personality evolution. Worth revisiting as she settles in.

### When stuck
- **Default (unhelpful)**: Pushes through, circles, makes it worse
- **What actually works**: Stepping away, or asking someone (always works out fine when she does)
- **Coaching note**: She knows the answer here. The pattern is pushing through under pressure. Help her build a "stuck protocol" — time-box, then ask.

### Procrastination pattern
- Low-deadline tasks get pushed indefinitely (tech debt, non-urgent work)
- Works best with clear stakes and momentum
- Low-pressure ambiguity is where she stalls

### Validation
- ~65% external validation, ~35% internal
- ~60% motivated by recognition for finished work, ~40% by the figuring-it-out process
- Needs to feel like her work is landing and being seen, especially early in a new role

---

## Confidence Profile (June 2026)
...
### Strong
- SQL (confident and capable)
- Exploratory data analysis
- Questioning business definitions and assumptions
- Product sense
...
### Strengths
- Questions the frame, not just the numbers — rare and high-value
- Strong product sense and stakeholder instincts
- Good self-awareness about what she wants and what drains her
- Understands experimentation well already

### Blindspots / Growth Areas
- Analytics engineering: dislikes it AND is new to it — double friction. Reframe: AE = earning the right to trust your data, not becoming an engineer.
- Python is the main technical gap blocking modeling goals
- Procrastination on low-urgency work
- Pushes through when stuck instead of stepping away or asking
- Still building the company context needed to do her best insight work

---

## Work-Life Balance

- **Means**: Hours. Hard cap around 40 hrs/week, goal of leaving by 4–4:30
- **Mental separation**: Good — switches off after work
- **End-of-day energy**: Usually a bit drained by end of day, but manageable
- **Active experiment**: Trying to shift to morning person schedule (6am wake, yoga/workout, 8:30 start)
...
- Confirmed: not panicking about AI, but paying attention. Correctly calibrated.
- ESTJ / Enneagram 1 noted and explained back to her

---

## Brain Dump Archive

*(Optional: key themes from past brain dumps worth remembering)*
